        ...
        <>
            <div className={styles.termsContainer}>
                ...
                <div >
                    ...
                    <div className={styles.eachTermsContainer}>
                        <p className={styles.eachTermsHeading}>Modification of Terms:<span className={styles.eachTermsDescription}> TechDetect Ventures reserves the right to modify or revise these Terms at any time. Any changes will be effective immediately upon posting the revised Terms on the Service. By continuing to use the Service after any such changes, you agree to be bound by the revised Terms.</span></p>
                    </div>
                    <div className={styles.eachTermsContainer}>
