...
const Articles = ({ articleImage, articleHeading, articleDetails, articleDetails1 }) => {
  const articles = [
    {
      id: 1,
    ...
    <>
      <div className={`${articleSectionStyles.articlesContainer} ${styles.termsContainer}`}>
        <div className={articleSectionStyles.mainArticle}>
          ...
          <h3 className={`${formContainerStyles.createAccount} ${articleSectionStyles.mainArticleHeading}`}>{articleHeading}</h3>
          <div className={articleSectionStyles.eachTermsDescriptionContainer}>
            <p className={styles.eachTermsDescription}>{articleDetails}</p>
            <p className={styles.eachTermsDescription}>{articleDetails1}</p>
          </div>
